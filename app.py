...
def main():
    ...
    if msg.startswith("あまおとくん"):
        serviceURL = ['https://gpt-bot.userlocal.jp/api/webhook/2c7e8d28','https://script.google.com/macros/s/AKfycby-2Fmm9VymDqU5cEnzadScSkmCoosUKlxhcTgPD9KjNliMpiNA8cfLQO-ZLOrzP0MOxQ/exec']
