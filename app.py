...
def main():
    ...
    if msg.startswith("あまおとくん"):
        serviceURL = ['https://gpt-bot.userlocal.jp/api/webhook/e8449bb8','https://script.google.com/macros/s/AKfycby-2Fmm9VymDqU5cEnzadScSkmCoosUKlxhcTgPD9KjNliMpiNA8cfLQO-ZLOrzP0MOxQ/exec']
